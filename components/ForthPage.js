...
const ForthPage = ({ route, navigation }) => {
  return (
    
      <SafeAreaView style={styles.container}>
<Text style={styles.tc}>1. Introduction</Text>
<Text style={styles.tcP}>Welcome to Dyniz!<br/><br/>
Clyps Technologies operates the dyniz.com (hereinafter referred to as “Service”).<br/><br/>
Our Privacy Policy governs your visit to dyniz.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.<br/><br/>
...
<Text style={styles.tc}>2. Definitions</Text>
<Text style={styles.tcP}>SERVICE means the dyniz.com website operated by Dyniz.<br/><br/>
...
<Text style={styles.tc}>3. Information Collection and Use</Text>
<Text style={styles.tcP}>We collect several different types of information for various purposes to provide and improve our Service to you.<br/>
</Text>

<Text style={styles.tc}>4. Types of Data Collected</Text>
<Text style={styles.tcP}>Personal Data<br/><br/>
...
0.3. Gender <br/><br/>
0.4. Phone number<br/><br/>
0.5. Location for restaurants<br/><br/>
0.6. Address, Country, State, Province, ZIP/Postal code, City<br/><br/>
0.7. Credit or Debit Card Details<br/><br/>
0.8. Interests, occupancy if you like.<br/><br/>
0.9. Cookies and Usage Data<br/><br/>
...
<Text style={styles.tc}>5. Use of Data</Text>
<Text style={styles.tcP}>
Dyniz uses the collected data for various purposes:<br/><br/>
...
<Text style={styles.tc}>6. Retention of Data</Text>
...
<Text style={styles.tc}>7. Transfer of Data</Text>
<Text style={styles.tcP}>Your information, including Personal Data, may be transferred to – and maintained on – computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.<br/><br/>
...
Dyniz will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.<br/><br/>


</Text>

<Text style={styles.tc}>8. Disclosure of Data</Text>
<Text style={styles.tcP}>We may disclose personal information that we collect, or you provide:<br/><br/>
...
<Text style={styles.tc}>9. Security of Data</Text>
<Text style={styles.tcP}>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.<br/><br/></Text>

<Text style={styles.tc}>10. Your Data Protection Rights Under General Data Protection Regulation (GDPR) </Text>
<Text style={styles.tcP}>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.<br/><br/>
We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.<br/><br/>
If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at contact_us@clyps.tech.<br/><br/>
...
0.4. users are able to change their personal information by emailing us at contact_us@clyps.tech.<br/><br/>
...
<Text style={styles.tc}>12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</Text>
<Text style={styles.tcP}>If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:<br/><br/>
...
To exercise your California data protection rights described above, please send your request(s) by email: contact_us@clyps.tech.<br/><br/>
...
<Text style={styles.tc}>13. Service Providers</Text>
<Text style={styles.tcP}>We may employ third party companies and individuals to facilitate our Service (“Service Providers”), provide Service on our behalf, perform Service-related services or assist us in analysing how our Service is used.<br/><br/>
...
<Text style={styles.tc}>14. Analytics</Text>
<Text style={styles.tcP}>We may use third-party Service Providers to monitor and analyze the use of our Service.<br/></Text>

<Text style={styles.tc}>15. CI/CD tools</Text>
<Text style={styles.tcP}>We may use third-party Service Providers to automate the development process of our Service.<br/></Text>

<Text style={styles.tc}>16. Advertising</Text>
<Text style={styles.tcP}>We may use third-party Service Providers to show advertisements to you to help support and maintain our Service.<br/></Text>

<Text style={styles.tc}>17. Behavioral Remarketing</Text>
<Text style={styles.tcP}>We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.<br/></Text>

<Text style={styles.tc}>18. Payments</Text>
<Text style={styles.tcP}>We may provide paid products and/or services within Service. In that case, we use third-party services for payment processing (e.g. payment processors).<br/><br/>
...
<Text style={styles.tc}>19. Links to Other Sites</Text>
<Text style={styles.tcP}>Our Service may contain links to other sites that are not operated by us. If you click a third party link, you will be directed to that third party’s site. We strongly advise you to review the Privacy Policy of every site you visit.<br/><br/>
We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services which may have their own privacy policies.<br/>

</Text>

<Text style={styles.tc}>20. Children’s Privacy</Text>
<Text style={styles.tcP}>Our Services are not intended for use by children under the age of 18 (“Child” or “Children”).<br/><br/>
...
<Text style={styles.tc}>21. Changes to This Privacy Policy</Text>
<Text style={styles.tcP}>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.<br/><br/>
...
<Text style={styles.tc}>22. Contact Us</Text>
<Text style={styles.tcP}>If you have any questions about this Privacy Policy, please contact us by email: contact_us@clyps.tech or visit the www.dyniz.com for quries.<br/><br/></Text>
